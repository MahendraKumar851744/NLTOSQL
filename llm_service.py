...
class RecursiveExtractionService:
    ...
    def __init__(self, api_url: str = "http://192.168.168.31:8000/extract", max_concurrent_requests: int = 20, log_file: str = "api_analysis.jsonl", prompts_file: str = "prompts.json"):
        ...
        # Per-extraction counters (reset in extract_from_new_data)
        self._sent: int = 0
        ...
        try:
            async with self.semaphore:
                ...
                if isinstance(result_data, list):
                    ...
                    logger.warning(f"Model returned invalid JSON: {result_data['raw_output']}")
                ...
                self._log_to_file(passage, chunk_type, formatted_glossary, extracted_list)

                return ExtractionResult(chunk_type=chunk_type, extracted_keywords=extracted_list, success=True, response_log=extracted_list)
